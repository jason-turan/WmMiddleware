...
namespace Middleware.Wm.Manhattan.Shipment
{
    ...
    [FixedLengthFile]
    [Table("ManhattanShipmentCartonDetail")]
    public partial class ManhattanShipmentCartonDetail : IGeneratedFlatFile
    {
        [Key]
        public int ManhattanShipmentCartonDetailId { get; set; }

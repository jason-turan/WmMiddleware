...
namespace Middleware.Wm.Manhattan.Shipment
{
    ...
    [FixedLengthFile]
    [Table("ManhattanShipmentCartonHeader")]
    public partial class ManhattanShipmentCartonHeader : IGeneratedFlatFile
    {
        [Key]
        public int ManhattanShipmentCartonHeaderId { get; set; }

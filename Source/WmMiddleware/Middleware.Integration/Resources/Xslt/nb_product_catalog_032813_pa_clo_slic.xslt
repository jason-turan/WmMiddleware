...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
  ...
  <xsl:template match="/">
    <xsl:element name="catalog" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
      <xsl:attribute name="catalog-id">        
        <xsl:text>masterCatalog_NewBalance</xsl:text>        
      </xsl:attribute>
  ...
  <xsl:template name="master-products">
    <xsl:for-each select="$models">
      ...
      <xsl:variable name="varColorSlicing" select="colorSlicing"/>
      <xsl:element name="product" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
              ...
              <xsl:for-each select="$image-groups">
                <xsl:element name="image-group" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
                  <xsl:if test="$productType = 'Master/Variant'">
                    <xsl:variable name="tmpVariationValue" select="../../ColorBucket"/>

                    <xsl:if test="$tmpVariationValue != ''">
        ...
        <xsl:element name="custom-attributes" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
          ...
          <xsl:apply-templates select="predecessor_style" />  <!-- needed lower case "s" in style-->
          ...
          <xsl:call-template name="IsWideWidth"></xsl:call-template>
          <xsl:call-template name="IsNarrowWidth"></xsl:call-template>
          <xsl:call-template name="MasterClearanceFlag"></xsl:call-template>
          <xsl:call-template name="CertonaClearanceFlag"></xsl:call-template>
          <xsl:call-template name="FitMessage"></xsl:call-template>
          
          <xsl:apply-templates select="base_style_number" /><!--certonaProductGroup-->

          <xsl:call-template name="IsCustomizer"></xsl:call-template>
          
          <xsl:apply-templates select="is_discountable" />
          <xsl:apply-templates select="is_lace_up" />
          <xsl:apply-templates select="is_made_in_usa" />
          <xsl:apply-templates select="is_assembled_in_usa" />
          <xsl:apply-templates select="map_price" />
          <xsl:apply-templates select="map_price_start" />
          <xsl:apply-templates select="map_price_end" />
          <xsl:apply-templates select="map2_price" />
          <xsl:apply-templates select="map2_price_start" />
          <xsl:apply-templates select="map2_price_end" />
          <xsl:apply-templates select="personalize_customize_type" />          
          <xsl:apply-templates select="custom_json" />

                           
          <xsl:apply-templates select="apparelFilterFitType"></xsl:apply-templates>
          <xsl:apply-templates select="footwearFilterFitType"></xsl:apply-templates>
          <xsl:apply-templates select="apparelFilterFeatures"></xsl:apply-templates>
          <xsl:apply-templates select="footwearFilterFeatures"></xsl:apply-templates>
          <xsl:apply-templates select="apparelFilterTechnology"></xsl:apply-templates>
          <xsl:apply-templates select="footwearFilterTechnology"></xsl:apply-templates>
          <xsl:apply-templates select="subCategoryList"></xsl:apply-templates>
          <xsl:apply-templates select="genderDisplay"></xsl:apply-templates>                   
         
          <xsl:apply-templates select="partCodes"></xsl:apply-templates>
          <xsl:apply-templates select="screenName"></xsl:apply-templates>
          <xsl:apply-templates select="dateCreated"></xsl:apply-templates>
          <xsl:apply-templates select="baseModel"></xsl:apply-templates>
          <xsl:apply-templates select="isGallery"></xsl:apply-templates>

          
          <xsl:apply-templates select="DesignGalleryColors"></xsl:apply-templates>

          <!--DRYDOCK-->
          <xsl:apply-templates select="shaft"></xsl:apply-templates>
          <xsl:apply-templates select="heelHeight"></xsl:apply-templates>
          
          <!--CorporateCampaign-->
          <xsl:apply-templates select="campaign_id"></xsl:apply-templates>
        ...
        <xsl:if test="$productType = 'Master/Variant'">
          <xsl:element name="variations" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
            <xsl:element name="attributes" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
              ...
              <xsl:apply-templates select="gender_list"></xsl:apply-templates>

              <xsl:if test="not(personalizedCustomized)">
                  ...
                  <xsl:if test="count($styles[base_style_number/text() = concat($model,'')]/Sizes/ProductSize[generate-id() = generate-id(key('styleKey', concat(../../base_style_number, '|', style_number))[1])]/style_number) &gt; 0 and $styles[base_style_number/text() = concat($model,'')]/Sizes/ProductSize[generate-id() = generate-id(key('styleKey', concat(../../base_style_number, '|', style_number))[1])]/style_number[1] != ''">
                    ...
                    <xsl:element name="variation-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
					  ...
					  <xsl:if test="$varColorSlicing = 'true'">
                          <xsl:attribute name="slicing-attribute">true</xsl:attribute>
				      </xsl:if>
      ...
      <xsl:for-each select="$variants">
        <xsl:element name="product" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
          <xsl:attribute name="product-id">
            ...
            <!--<xsl:value-of select="concat(normalize-space(upc_number), '-TESTDATA')" disable-output-escaping="yes" />-->
          </xsl:attribute>
          <xsl:call-template name="base-product-info">
          ...
          <!--I use this to save Merchandise from themselves...SKUs should not have long descriptions-->
          <xsl:element name="long-description" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31"></xsl:element>
          ...
          <xsl:element name="custom-attributes" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
              <xsl:if test="customizerGender">
                <xsl:call-template name="custom-attribute">
                  <xsl:with-param name="attribute-name">customizerGender</xsl:with-param>
                  <xsl:with-param name="attribute-value" select="customizerGender/text()" />
                </xsl:call-template>
              </xsl:if>
              <xsl:if test="not(customizerGender)">
                <xsl:call-template name="custom-attribute">
              ...
              <xsl:call-template name="custom-attribute">
                <xsl:with-param name="attribute-name">styleNumber</xsl:with-param>
                <!--<xsl:with-param name="attribute-value" select="../../style_number" />-->
                <xsl:with-param name="attribute-value" select="style_number/text()" />
              </xsl:call-template>
              
              
              <!--Addition for Associated SKUs-->
              <xsl:call-template name="custom-attribute">
                <xsl:with-param name="attribute-name">associatedSKU</xsl:with-param>
                <!--<xsl:with-param name="attribute-value" select="../../style_number" />-->
                <xsl:with-param name="attribute-value" select="inherited_upc_number/text()" />
              </xsl:call-template>

              <!--<xsl:call-template name="ClearanceFlag"></xsl:call-template>-->

              <xsl:call-template name="SizeRefinement"></xsl:call-template>
              <xsl:call-template name="SizeRefinement2"></xsl:call-template>
  ...
  <xsl:template match="predecessor_style">    
    <!--<xsl:if test=". != ''">-->
      ...
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">predecessor</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    <!--</xsl:if>-->
  </xsl:template>
  <xsl:template match="successor_style">
    <!--<xsl:if test=". != ''">-->
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">successor</xsl:with-param>
        <xsl:with-param name="attribute-value"  select="." />
      </xsl:call-template>
    <!--</xsl:if>-->
    <!--Empty Out this attribute-->
    <xsl:call-template name="custom-attribute">
  ...
  <xsl:template name="CertonaClearanceFlag">
    <xsl:for-each select="certonaClearanceFlag">
      <xsl:element name="custom-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
        <xsl:attribute name="attribute-id">certonaClearanceFlag</xsl:attribute>
        <xsl:if test="@site-id != ''">
          <xsl:attribute name="site-id">
            <xsl:value-of select="@site-id" disable-output-escaping="yes"></xsl:value-of>
          </xsl:attribute>
  ...
  <xsl:template name="FitMessage">
    <xsl:for-each select="fitMessage">
      <xsl:element name="custom-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
        ...
        <xsl:attribute name="attribute-id">fitMessage</xsl:attribute>
        <xsl:if test="@site-id != ''">
          <xsl:attribute name="site-id">
            <xsl:value-of select="@site-id" disable-output-escaping="yes"></xsl:value-of>
          </xsl:attribute>
...
<!-- Bug 5422: dynamic filter update -->
  <xsl:template name="SizeRefinement">
    <xsl:for-each select="SizeRefinement">
      <xsl:element name="custom-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
        <xsl:attribute name="attribute-id">sizeRefinement</xsl:attribute>
        <xsl:if test="@site-id != ''">
          <xsl:attribute name="site-id">
            <xsl:value-of select="@site-id" disable-output-escaping="yes"></xsl:value-of>
          </xsl:attribute>
  ...
  <xsl:template name="SizeRefinement2">
    <xsl:for-each select="SizeRefinement2">
      <xsl:element name="custom-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
        <xsl:attribute name="attribute-id">sizeRefinement2</xsl:attribute>
        <xsl:if test="@site-id != ''">
          <xsl:attribute name="site-id">
            <xsl:value-of select="@site-id" disable-output-escaping="yes"></xsl:value-of>
          </xsl:attribute>
  ...
  <xsl:template match="map_price">
    <xsl:if test=". != ''">
      <!--Demandware created the MAPprice after I already created the productMapPrice-->
      <!--productMapPRice is not used by code ...did global search, so that can be removed...MAPprice is field that IS used in code -->
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">productMapPrice</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">MAPprice</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  <xsl:template match="map_price_start">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">MAPpriceStart</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  <xsl:template match="map_price_end">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">MAPpriceEnd</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  <xsl:template match="map2_price">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">MAP2price</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  <xsl:template match="map2_price_start">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">MAP2priceStart</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  <xsl:template match="map2_price_end">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">MAP2priceEnd</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template match="apparelFilterFitType">
    ...
    <xsl:element name="custom-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
      <xsl:attribute name="attribute-id">_ApparelFitTypes</xsl:attribute>
      <xsl:for-each select="string">
        <xsl:element name="value" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
          <!--this clears this old value out-->
        </xsl:element>
      </xsl:for-each>
    </xsl:element>
  ...
  <xsl:template match="base_style_number">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">certonaProductGroup</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template match="shaft">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">shoeCollarHeight</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>

  <xsl:template match="heelHeight">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">heelHeight</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  
    <xsl:template match="campaign_id">
    <xsl:if test=". != ''">
      <xsl:call-template name="custom-attribute">
        <xsl:with-param name="attribute-name">corporateCampaign</xsl:with-param>
        <xsl:with-param name="attribute-value" select="." />
      </xsl:call-template>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="base-product-info">
    ...
    <!--<xsl:element name="long-description" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
      <xsl:call-template name="cdata_start" />
      <xsl:value-of select="$long-description" disable-output-escaping="yes" />
      <xsl:call-template name="cdata_end"/>
    </xsl:element>-->
  </xsl:template>
  ...
  <xsl:template match="gender_list">
    <xsl:element name="variation-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
      <xsl:attribute name="variation-attribute-id">customizerGender</xsl:attribute>
      <xsl:attribute name="attribute-id">customizerGender</xsl:attribute>
      <xsl:element name="variation-attribute-values" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
        <xsl:for-each select="values/GenderListItem">
  ...
  <xsl:template match="upc_number">
    <xsl:element name="variant" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
      <xsl:attribute name="product-id">
        ...
        <!--<xsl:value-of select="concat(normalize-space(.), '-TESTDATA')" disable-output-escaping="yes" />-->
      </xsl:attribute>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template match="DesignGalleryColors">
    <xsl:element name="custom-attribute" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
      <xsl:attribute name="attribute-id">designgallerycolor</xsl:attribute>
      <xsl:for-each select="string">
        <xsl:element name="value" namespace="http://www.demandware.com/xml/impex/catalog/2006-10-31">
          <xsl:value-of select="." disable-output-escaping="yes"/>
        </xsl:element>

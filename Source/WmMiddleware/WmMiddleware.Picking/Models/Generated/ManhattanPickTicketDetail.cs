...
namespace WmMiddleware.Picking.Models
{
    ...
    internal partial class ManhattanPickTicketDetail
    {
        ...
        public int ErrorSequence
        {
            ...
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 9) throw new ArgumentOutOfRangeException("value");
        ...
        [FixedLengthField(3, 9, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(4, 7, PaddingChar = '0', Padding = Padding.Left)]
        public int TimeCreated
        {
            get { return _timeCreated; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 7) throw new ArgumentOutOfRangeException("value");
                _timeCreated = value;
            }
        }
        ...
        [FixedLengthField(10, 5, PaddingChar = '0', Padding = Padding.Left)]
        public int PickticketLineNumber
        {
            get { return _pickticketLineNumber; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 5) throw new ArgumentOutOfRangeException("value");
                _pickticketLineNumber = value;
            }
        }

        private int _sizeRelPosninTable;
        [FixedLengthField(11, 2, PaddingChar = '0', Padding = Padding.Left)]
        public int SizeRelPosninTable
        {
            get { return _sizeRelPosninTable; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 2) throw new ArgumentOutOfRangeException("value");
        ...
        public string Warehouse
        {
            ...
            set
            {
                if(value.Length > 3) throw new ArgumentOutOfRangeException("value");
                _warehouse = value;
            }
        }
        ...
        public string SizeDescription
        {
            ...
            set
            {
                if(value.Length > 15) throw new ArgumentOutOfRangeException("value");
        ...
        [FixedLengthField(43, 11, PaddingChar = '0', Padding = Padding.Left)]
        public long OriginalOrderQuantity_Backing
        {
            get { return _originalOrderQuantity; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 11) throw new ArgumentOutOfRangeException("value");
        ...
        [FixedLengthField(44, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(45, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(46, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(47, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(48, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(49, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(50, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(51, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(52, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(53, 13, PaddingChar = '0', Padding = Padding.Left)]
        public long UnitWeight_Backing
        {
            get { return _unitWeight; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 13) throw new ArgumentOutOfRangeException("value");
                _unitWeight = value;
            }
        }
        ...
        [FixedLengthField(54, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(55, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(56, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(57, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        public string StyleDescription
        {
            ...
            set
            {
                if(value.Length > 35) throw new ArgumentOutOfRangeException("value");
        ...
        [FixedLengthField(64, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(65, 5, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(71, 7, PaddingChar = '0', Padding = Padding.Left)]
        ...
        public string IsbnNumber
        {
            ...
            set
            {
                if(value.Length > 13) throw new ArgumentOutOfRangeException("value");
                _isbnNumber = value;
            }
        }
        ...
        private long _price;
        [FixedLengthField(83, 19, PaddingChar = '0', Padding = Padding.Left)]
        public long Price_Backing
        {
            get { return _price; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 19) throw new ArgumentOutOfRangeException("value");
                _price = value;
            }
        }
        ...
        [FixedLengthField(84, 19, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(85, 19, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(87, 5, PaddingChar = '0', Padding = Padding.Left)]
        ...
        public string MessageId
        {
            ...
            set
            {
                if(value.Length > 7) throw new ArgumentOutOfRangeException("value");
                _messageId = value;
            }
        }
        ...
        [FixedLengthField(93, 9, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(94, 9, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(95, 3, PaddingChar = '0', Padding = Padding.Left)]
        public int OverSizeLength
        {
            get { return _overSizeLength; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 3) throw new ArgumentOutOfRangeException("value");
        ...
        [FixedLengthField(99, 5, PaddingChar = '0', Padding = Padding.Left)]
        ...
        private string _speclInstructionCode1;
        [FixedLengthField(107, 2, PaddingChar = ' ', Padding = Padding.Right, NullValue="  ")]
        public string SpeclInstructionCode1
        {
            get { return _speclInstructionCode1; }
            set
            {
                if(value.Length > 2) throw new ArgumentOutOfRangeException("value");
                _speclInstructionCode1 = value;
            }
        }

        private string _speclInstructionCode2;
        [FixedLengthField(108, 2, PaddingChar = ' ', Padding = Padding.Right, NullValue="  ")]
        public string SpeclInstructionCode2
        {
            get { return _speclInstructionCode2; }
            set
            {
                if(value.Length > 2) throw new ArgumentOutOfRangeException("value");
                _speclInstructionCode2 = value;
            }
        }

        private string _speclInstructionCode3;
        [FixedLengthField(109, 2, PaddingChar = ' ', Padding = Padding.Right, NullValue="  ")]
        public string SpeclInstructionCode3
        {
            get { return _speclInstructionCode3; }
            set
            {
                if(value.Length > 2) throw new ArgumentOutOfRangeException("value");
                _speclInstructionCode3 = value;
            }
        }

        private string _speclInstructionCode4;
        [FixedLengthField(110, 2, PaddingChar = ' ', Padding = Padding.Right, NullValue="  ")]
        public string SpeclInstructionCode4
        {
            get { return _speclInstructionCode4; }
            set
            {
                if(value.Length > 2) throw new ArgumentOutOfRangeException("value");
                _speclInstructionCode4 = value;
            }
        }

        private string _speclInstructionCode5;
        [FixedLengthField(111, 2, PaddingChar = ' ', Padding = Padding.Right, NullValue="  ")]
        public string SpeclInstructionCode5
        {
            get { return _speclInstructionCode5; }
            set
            {
                if(value.Length > 2) throw new ArgumentOutOfRangeException("value");
                _speclInstructionCode5 = value;
            }
        }
        ...
        [FixedLengthField(115, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(116, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(117, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(118, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(119, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        public string RecordExpansionField
        {
            ...
            set
            {
                if(value.Length > 30) throw new ArgumentOutOfRangeException("value");
        ...
        public string NmfcCode
        {
            ...
            set
            {
                if(value.Length > 9) throw new ArgumentOutOfRangeException("value");
                _nmfcCode = value;
            }
        }
        ...
        private string _innerCtnBreakAttr;
        [FixedLengthField(130, 3, PaddingChar = ' ', Padding = Padding.Right, NullValue="   ")]
        public string InnerCtnBreakAttr
        {
            get { return _innerCtnBreakAttr; }
            set
            {
                if(value.Length > 3) throw new ArgumentOutOfRangeException("value");
                _innerCtnBreakAttr = value;
            }
        }
        ...
        public string TpePurchaseOrder
        {
            ...
            set
            {
                if(value.Length > 25) throw new ArgumentOutOfRangeException("value");
        ...
        [FixedLengthField(152, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(153, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(154, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(155, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(156, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(157, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(158, 13, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(166, 5, PaddingChar = '0', Padding = Padding.Left)]
        ...
        private int _poLine;
        [FixedLengthField(167, 6, PaddingChar = '0', Padding = Padding.Left)]
        public int PoLine
        {
            get { return _poLine; }
            set
            {
                if(value.ToString(CultureInfo.InvariantCulture).Length > 6) throw new ArgumentOutOfRangeException("value");
                _poLine = value;
            }
        }
        ...
        [FixedLengthField(169, 9, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(170, 11, PaddingChar = '0', Padding = Padding.Left)]
        ...
        [FixedLengthField(171, 11, PaddingChar = '0', Padding = Padding.Left)]

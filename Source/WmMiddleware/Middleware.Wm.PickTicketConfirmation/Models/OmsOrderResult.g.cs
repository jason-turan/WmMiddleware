...
namespace Middleware.Wm.PickTicketConfirmation.Models
{
    ...
    {
        public int header_auto_id { get; set; } //(int, not null)
        ...
        public string header_ledger_status { get; set; } //(varchar(10), not null)
        ...
        public string header_discount_category { get; set; } //(varchar(20), null)
        public string header_discount_id { get; set; } //(varchar(20), null)
        public string HeaderWarehouseStatus { get; set; } //(varchar(5), not null)
        public int detail_auto_id { get; set; } //(int, not null)
        ...
        public string item_discount_category { get; set; } //(varchar(20), null)
        public string item_discount_id { get; set; } //(varchar(20), null)
        public string ItemWarehouseStatus { get; set; } //(varchar(5), not null)
        public string item_ledger_status { get; set; } //(varchar(10), not null)

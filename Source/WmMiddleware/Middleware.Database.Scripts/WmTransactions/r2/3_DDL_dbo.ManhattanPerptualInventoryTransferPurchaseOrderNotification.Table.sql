...
ALTER TABLE [dbo].[ManhattanPerptualInventoryTransferPurchaseOrderNotification]  
ADD CONSTRAINT PurchaseOrderNumberUnique 
UNIQUE NONCLUSTERED([PurchaseOrderNumber])
